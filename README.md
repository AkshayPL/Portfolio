# Akshay P L — XR Developer Portfolio

A high-performance, lightweight, and responsive dark-mode portfolio built to showcase C# systems development, immersive Unity simulations, physical hardware integrations, and networking codebases.
